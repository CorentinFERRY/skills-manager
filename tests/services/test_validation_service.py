...
class TestCreatePreValidation:
    ...
    def test_returns_pre_validation_with_correct_status(self):
        validator = Learner(id=2, name="Bob")
    ...
    def test_returns_pre_validation_with_validator_name(self):
        validator = Learner(id=2, name="Bob")
        validator.add_validated_skill(1)
        db.learners.append(validator)
    ...
    def test_saves_pre_validation_in_db(self):
        validator = Learner(id=2, name="Bob")
        validator.add_validated_skill(1)
        db.learners.append(validator)
